# based on https://github.com/abetlen/llama-cpp-python/blob/main/examples/low_level_api/low_level_api_llama_cpp.py
#NOTE This doesn't work because llama_eval is deprecated and not available anymore. We planned to add printing the
#     graph in this script but it was easier to patch this into llama.cpp.
...
MODEL_PATH = os.environ.get("MODEL", "./models/mistral-nemo--latest.gguf")
